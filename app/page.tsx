        ...
        <header className={styles.header}>
          <div className={base.container}>
            <div className={styles.headerInner}>
              ...
              >
                <Image src="/img/logo.png" alt="Logo" width={44} height={44} />
                Ethention
              </div>
            ...
            <div className={styles.appDashboardInner}>
                ...
                <div className={styles.appDashboardInfoWrap}>
                  <div className={styles.appDashboardInfo}>
                    <div className={styles.appDashboardInfoBlock}>
                      <div className={styles.appDashboardInfoItem}>
                        <div>
                          <Swap />
                        </div>
                ...
                <div className={styles.appDashboardInfoContent}>
                  <div className={styles.appReward}>
                    ...
                    <div className={styles.appRewardItem}>
                      <div className={styles.appRewardItemIcon}>
                        <Eth />
                      </div>

                      <p className={styles.appRewardItemText}>0.41 ETH</p>

                      <button
                        className={styles.appRewardItemButton}
                  ...
                  <div className={styles.appCollectedInner}>
                    <div className={styles.appCollected}>
                      ...
                      <div className={styles.appCollectedTable}>
                        <div className={styles.appCollectedTableItem}>
                          <div className={styles.appCollectedTableItemCount}>
                            <span>
                              <Eth />
                            </span>
                            1.2
                          ...
                          <p className={styles.appCollectedTableItemTime}>
                            7:12 PM
                          </p>

                          <p className={styles.appCollectedTableItemDate}>
                            10.01.2025
                          </p>
                        </div>
              ...
              <div className={styles.appLeaderboardInner}>
                <div className={styles.appLeaderboard}>
                  <p className={styles.appRewardTitle}>Leaderboard.</p>

                  <div className={styles.appLeaderTable}>
                    <div className={styles.appLeaderTableItem}>
                      <div className={styles.appLeaderTableItemWallet}>
                        <span>
                          <Wallet />
                        </span>
                        0x23...34
                      ...
                      <p className={styles.appLeaderTableItemCount}>
                        1.2
                        <Eth />
                      </p>
                    </div>
              ...
              <div className={styles.appGetmore}>
                ...
                <p className={styles.appGetmoreTitle}>Get more</p>
                ...
                <button
                  ...
                  onClick={() => setUpgradeModal((prev) => !prev)}
                >
                  Upgrade
                  <span>
                    <ArrowRight />
          ...
          <div className={base.container}>
            <div className={styles.appTableInner}>
              <div className={styles.appTableHeader}>
                ...
                <p className={styles.appTableHeaderItem}>User</p>

                <p className={styles.appTableHeaderItem}>Time</p>

                <p className={styles.appTableHeaderItem}>Prize Color</p>

                <p className={styles.appTableHeaderItem}>Double</p>

                <p className={styles.appTableHeaderItem}>Payout</p>
              </div>
              ...
              <div className={styles.appTableContent}>
                <div className={styles.appTableItem}>
                  ...
                  >
                    <div className={styles.appTableItemUserName}>
                      <Blind />
                      Hidden
                    </div>
                  </div>
                ...
                <div className={styles.appTableItem}>
                  ...
                  >
                    <div className={styles.appTableItemUserName}>Mickle</div>
                  </div>
        ...
        <div className={styles.upgradeModal}>
          ...
          <div className={styles.upgradeBurnItems}>
            <div className={styles.upgradeBurnItem}>
              ...
              <p className={styles.upgradeBurnItemText}>Hidden Prizes</p>
      ...
      <Modal value={syncModal}>
        <div className={styles.upgradeModal}>
          ...
          <p className={styles.clientText}>
            Before you continue to your dashboard please sync your browser
            extension si the app.
          </p>
        ...
        <div className={styles.extensionModal}>
          ...
          {step <= 2 && (
            <div className={styles.extensionLogin}>
              {step === 1 && (
                <>
                  <div className={styles.extensionLoginInputs}>
                    <div className={styles.extensionLoginInputInner}>
                      <input
                        className={styles.extensionLoginInput}
                    ...
                    <button
                      className={cn(styles.extensionLoginButton, {
                        [styles.disabled]: !clientId,
                      })}
                      onClick={() => setStep(2)}
                    >
                      Get started
                  ...
                  <div className={styles.extensionLoginWrap}>
                    <p className={styles.extensionLoginText}>
                      Don`t have an <span>Client ID?</span>
                    </p>

                    <button className={styles.extensionLoginClient}>
                      GET Client ID
                    </button>
                  </div>
                </>
              ...
              {step === 2 && (
                <>
                  <p className={styles.clientIdTitle}>Your Client ID</p>
                  ...
                  <div className={styles.clientAttentionBlock}>
                    <div className={styles.clientAttentionTitleInner}>
                      <span>!</span>

                      <p className={styles.clientAttentionTitle}>Attention</p>
                    </div>

                    <p className={styles.clientAttentionText}>
                      Client ID is unique and can be used for login and
                      registration, but once lost cannot be recovered and it is
          ...
          {step === 3 && (
            <>
              <div className={styles.extensionHeader}>
                <Image src="/img/logo.png" alt="logo" width={37} height={37} />
                Ethention
              </div>

              <div className={styles.extensionCount}>
                <div className={cn(styles.extensionCountValue, styles.green)}>
                  <p>
                    <span>99</span>
                  </p>
                </div>
                ...
                <p className={styles.extensionCountTitle}>Attention Score</p>
              </div>

              <div className={styles.extensionDailyWrap}>
                <div className={styles.extensionDaily}>
                  <div className={styles.extensionDailyTitleWrap}>
                    <div className={styles.extensionDailyTitleInner}>
                      <p className={styles.extensionDailyTitle}>
                        Daily Rewards
                      </p>

                      <p className={styles.extensionDailyText}>
                        There are 5 hidden rewards today on your <span>X</span>
                      </p>
                    </div>

                    <div className={styles.extensionDailyCount}>5</div>
                  </div>

                  <div className={styles.extensionDailyItems}>
                    <div
                      className={cn(styles.extensionDailyItem, styles.active)}
                    ></div>
                    <div
                      className={cn(styles.extensionDailyItem, styles.active)}
                    ></div>
                    <div
                      className={cn(styles.extensionDailyItem, styles.active)}
                    ></div>
                    <div className={styles.extensionDailyItem}></div>
                    <div className={styles.extensionDailyItem}></div>
                  </div>
                </div>
                ...
                <div className={styles.extensionFlashInner}>
                  ...
                  <p className={styles.extensionFlashText}>
                    Do you want to increase your daily reards or do you want
                    bigger rewards?
                  </p>
                </div>
            ...
            <>
              ...
              <div className={styles.extensionDailyWrap}>
                <div className={styles.extensionInfoWindow}>
                  ...
                  <div className={styles.extensionInfoTextBlock}>
                    <p className={styles.extensionInfoTitle}>Congrats!</p>
            ...
            <>
              ...
              <div className={styles.extensionDailyWrap}>
                <div className={styles.extensionInfoWindow}>
                  ...
                  <div className={styles.extensionInfoTextBlock}>
                    <p className={styles.extensionInfoText}>
                      In order to double your reward please guess where the
                      number bigger then 7 is
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.extensionGame}>
                  <button
                    ...
                    onClick={() => setStep(6)}
                  >
                    <span className={styles.extensionGameChoiceQuestion}>
                      <Question />
                    </span>

                    <span className={styles.extensionGameChoiceText}>Here</span>
                  </button>
          ...
          {step === 6 && (
            <>
              ...
              <div className={styles.extensionDailyWrap}>
                <div className={styles.extensionInfoWindow}>
                  <div className={styles.extensionInfoIcon}>
                    <Image src="/img/x2.svg" alt="x2" width={31} height={31} />
                  </div>
            ...
            <>
              ...
              <div className={styles.extensionDailyWrap}>
                <div className={styles.extensionInfoWindow}>
                  ...
                  <div className={styles.extensionInfoTextBlock}>
                    <p className={styles.extensionInfoTitle}>
                      Unlucky.You lost.
                    </p>
